...
public class LanguageModel {
    ...
    public String generate(String initialText, int textLength) {
        ...
        // Set the initial window to the last windowLength characters of the initial
        // text
        String window = initialText.substring(initialText.length() - windowLength);
        String gt = window;
        int counter = textLength + windowLength;
        // Continue generating text until the length of the generated text reaches the
        // desired text length
        while (gt.length() < counter) {
            ...
            // If the current window is not found in the map, stop the process and return
            ...
            // connects the generated character to the generated text based on the
            // stringbuilder
            gt += nextChar;
            ;
            // Move the window by removing the first character and adding the newly
            // generated character
